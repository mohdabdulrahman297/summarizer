...
Note: Every single point MUST start with ". " followed by an emoji. Do not use numbered lists. Always maintain this exact format for ALL points in ALL sections.

Never deviate from this format. Everyline that contains content must start with ". " followed by an emoji.`;
