  ...
  return (
    ...
    >
      <MotionDiv
        ...
        className="relative p-[1px] overflow-hidden rounded-full bg-gradient-to-r from-blue-50 via-blue-500 to-purple-500 animate-gradient-x-group"
      >
        <Badge
          variant={"secondary"}
          className="relative px-6 py-2 text-base font-medium bg-white rounded-full group-hover:bg-gray-300 transition-colors duration-200"
        >
      ...
      <MotionH1 className="font-bold py-6 text-center text-4xl">
        Summarize your PDFs with{" "}
